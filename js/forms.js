$( document ).ready(function() {
  ...
  $("#payment-form-2").on("submit", function(){

    document.getElementById("fw_btn").disabled = true;
    document.getElementById('fw_btn').innerHTML = "<div class='d-flex justify-content-center'><div style='height:20px; width:20px;' class='spinner-border' role='status'><span class='sr-only'></span></div>&nbsp;Loading</div>";
